...
export function meta() {
  return [
    { title: "VeneBus | Crear Cuenta" },
    { name: "description", content: "Regístrate para gestionar tus pasajes" },
  ];
}
        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-100 dark:border-gray-700">
          ...
          <div className="mb-8">
            <div className="flex border-b border-[#dce3e5] dark:border-gray-700 gap-8">
              <div onClick={() => navigate('/iniciar-sesion')} className="cursor-pointer flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#637f88] dark:text-gray-400 pb-[13px] pt-4 hover:text-primary transition-all" >
          ...
          <div className="mb-6">
            <h2 className="text-[#111618] dark:text-white text-2xl font-bold font-heading">Página de Registro de Usuario</h2>
            <p className="text-[#637f88] dark:text-gray-400 text-sm mt-1">Completa tus datos para empezar a viajar.</p>
          </div>

          <form className="space-y-4">
            {/* Nombre */}
            <div className="flex flex-col gap-1.5">
              <label className="text-[#111618] dark:text-gray-200 text-sm font-semibold">Nombre Completo</label>
              <div className="relative">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg">person</span>
                <input type="text" placeholder="Juan Pérez" required className="flex w-full rounded-lg text-[#111618] dark:text-white border border-[#dce3e5] dark:border-gray-600 bg-white dark:bg-gray-700 h-12 pl-12 pr-4 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input type="email" placeholder="ejemplo@correo.com" required className="flex w-full rounded-lg text-[#111618] dark:text-white border border-[#dce3e5] dark:border-gray-600 bg-white dark:bg-gray-700 h-12 pl-12 pr-4 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400" />
              </div>
            </div>

            {/* Cédula */}
            <div className="flex flex-col gap-1.5">
              <label className="text-[#111618] dark:text-gray-200 text-sm font-semibold">Cédula de Identidad</label>
              <div className="relative">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg">badge</span>
                <input type="text" placeholder="V-00.000.000" required className="flex w-full rounded-lg text-[#111618] dark:text-white border border-[#dce3e5] dark:border-gray-600 bg-white dark:bg-gray-700 h-12 pl-12 pr-4 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input type="password" placeholder="••••••••" required className="flex w-full rounded-lg text-[#111618] dark:text-white border border-[#dce3e5] dark:border-gray-600 bg-white dark:bg-gray-700 h-12 pl-12 pr-4 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all placeholder:text-gray-400" />
              </div>
              <p className="text-[10px] text-gray-400 px-1">Mínimo 8 caracteres, incluyendo números y letras.</p>
            </div>

            <div className="flex items-start gap-3 py-2">
              <input id="terms" type="checkbox" required className="mt-1 w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary" />
              <label htmlFor="terms" className="text-sm text-[#637f88] dark:text-gray-400">
                Aceptar <a className="text-primary font-semibold hover:underline" href="#">Términos y Condiciones</a> y la Política de Privacidad de VeneBus.
              </label>
            </div>
          ...
          <div className="relative my-8 text-center">
            ...
            <span className="relative bg-white dark:bg-gray-800 px-4 text-xs font-semibold text-gray-400 uppercase tracking-widest">O regístrate con</span>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ¿Ya tienes una cuenta? <a className="text-primary font-bold hover:underline" href="/iniciar-sesion">Inicia Sesión</a>
            </p>
          </div>
        </div>
      </div>
